          ...
          <div class="section-content">
            <div class="product-list">
              ...
              if (isset($_GET['search'])) {
                ...
                $books = array_filter($books, function ($book) use ($search_param) {
                  $title = trim(mb_strtoupper($book['title']));
                  $author = trim(mb_strtoupper($book['author']));
                  $cover = trim(mb_strtoupper($book['cover']));
                  $tags = strtoupper($book['tags']);
                  $description = trim(mb_strtoupper($book['description']));
                  $search_param = trim(mb_strtoupper($search_param));

                  return str_contains($title, $search_param) || str_contains($description, $search_param) || str_contains($author, $search_param) || str_contains($cover, $search_param) || str_contains($tags, $search_param);
                });
              }
