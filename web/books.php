...
<head>
  ...
  <link rel="stylesheet" href="style/pages/books.css">
  <script src="js/input-file.js" defer></script>
  <title>BookHaven: Книги</title>
</head>
      ...
      <div class="page-content__wrapper">
        <section class="section">
          <header class="section-header">
            ...
            <a href="books/add.php" class="button filled">
                ...
                <tbody>
                  <?php foreach ($books as $book): ?>
                    <tr>
                      ...
                      <td class="table-book">
                        <div class="table-book__img">
                          <img src="assets/<?php echo $book['img'] ?>" alt="">
                        </div>
                        <span class="table-book__title">
                          <?php echo $book['title'] ?>
                        </span>
                      </td>
                      <td>
                      ...
                      <td>
                        <a href="books/edit.php?id=<?php echo $book['id'] ?>" class="button icon"><svg width="24"
                        ...
                        <a href="../vendors/delete_book.php?id=<?php echo $book['id'] ?>" class="button icon">
